...
import es.cursojava.entities.Cliente;
...
public class HibernateIndices {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5_000_000; i++) {
            es.cursojava.entities.Cliente cliente = new es.cursojava.entities.Cliente("Nombre " + i , "usuario" + i + "@ejemplo.com");
    ...
    private static void consultarDatos (Session session){
        ...
        es.cursojava.entities.Cliente resultado = session.createQuery("FROM Cliente WHERE email = :email", es.cursojava.entities.Cliente.class)
